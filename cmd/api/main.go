...
дополнительную информацию о произведении, его авторе и
историческом значении цитируемого фрагмента, уложи свой ответ в не более чем 200 слов:`
	query = `Предоставь релевантные литературные цитаты по этим ключевым словам, уложи свой ответ в не более чем 200 слов:`
)
